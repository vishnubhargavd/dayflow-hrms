...
-- AlterTable PerformanceGoal (previously created as stub in initial migration)
ALTER TABLE "PerformanceGoal" ALTER COLUMN "status" DROP DEFAULT;
ALTER TABLE "PerformanceGoal" ALTER COLUMN "status" TYPE "GoalStatus" USING "status"::"GoalStatus";
ALTER TABLE "PerformanceGoal" ALTER COLUMN "status" SET DEFAULT 'NOT_STARTED';
...
-- AlterTable PerformanceReview (previously created as stub in initial migration)
ALTER TABLE "PerformanceReview" RENAME COLUMN "rating" TO "overallRating";
ALTER TABLE "PerformanceReview" ALTER COLUMN "overallRating" DROP NOT NULL;
ALTER TABLE "PerformanceReview" DROP COLUMN IF EXISTS "feedback";
